...
nexus.ammo(
item.nickel, Object.assign(new BasicBulletType(8, 49), {
    ammoMultiplier: 1,

    frontColor: Color.valueOf("B5FFECFF"),
    backColor: Color.valueOf("74E8E1FF"),
    width: 8,
    height: 15,
    shrinkY: 0,
    shrinkX: 0,
    ...
    trailColor: Color.valueOf("B5FFECFF"),
    trailParam: 2,
    trailWidth: 2,
    trailLength: 7,
    trailRotation: true,
    ...
    Object.assign(new WaveEffect(), {
        ...
        strokeFrom: 7.5,
        strokeTo: 0,
        colorFrom: Color.valueOf("B5FFECFF"),
        colorTo: Color.valueOf("74E8E1FF")
    }),
...
Items.graphite, Object.assign(new BasicBulletType(8, 67), {
    reloadMultiplier: 0.6,
    ammoMultiplier: 1,
    rangeChange: 24,

    frontColor: Color.valueOf("f7e8aa"),
    backColor: Color.valueOf("f9f4dc"),
    width: 8,
    height: 15,
    shrinkY: 0,
    shrinkX: 0,
    ...
    trailColor: Color.valueOf("f7e8aa"),
    trailParam: 2,
    trailWidth: 2,
    trailLength: 7,
    trailRotation: true,
    ...
    Object.assign(new WaveEffect(), {
        ...
        strokeFrom: 7.5,
        strokeTo: 0,
        colorFrom: Color.valueOf("f7e8aa"),
        colorTo: Color.valueOf("f9f4dc")
    }),
    Object.assign(new ParticleEffect(), {
        offset: 30,
        particles: 10,
...
Items.silicon, Object.assign(new BasicBulletType(8, 53), {
...
item.manganese, Object.assign(new BasicBulletType(8, 77), {
...
item.chromium, Object.assign(new ReduceArmorBulletType(8, 77, 1), {
    ammoMultiplier: 1,
...
Items.pyratite, Object.assign(new BasicBulletType(8, 79), {
